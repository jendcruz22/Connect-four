...
import pygame					#pythons event based gaming library
import sys
import math
#Imports
...
BLUE = (0, 0, 250)			#RGB value intake format
BLACK = (0,0,0)
RED = (255,0,0)
YELLOW = (255,255,0)
...
def print_board(board):
	print(np.flip(board, 0))		#numpy function to change orientation of the board along the xax

def winning_move(board, piece):				# Check horizontal locations for win
...
def draw_board(board):				#navigates the graphics
...
SQUARESIZE = 100			#size of each pizel*100
